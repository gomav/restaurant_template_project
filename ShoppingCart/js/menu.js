...
function store() {
    this.products = [
      new product("PAH", "Papa a la Hauncaina", "Yukon gold potato with ají Amarillo, feta cheese sauce on butter lettuce, with hard-boiled egg and olive.", 12, 90, 0, 2, 0, 1, 2),
      new product("TEQ", "Tequeños", "Wonton puffs filled with wild Dungeness crab, shrimp, cream cheese, red bell pepper, and chives, served with Huancaína & Huancatay sauce.", 16, 90, 0, 1, 1, 1, 2),
...
// menu.prototype.getProduct = function (sku) {
//     for (var i = 0; i < this.products.length; i++) {
//       return this.products[i];
//     }
//     return null;
